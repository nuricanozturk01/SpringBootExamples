package nuricanozturk.dev.app.web.veterinarian.controller;

import nuricanozturk.dev.app.web.veterinarian.model.VeterinarianSaveModel;
import nuricanozturk.dev.app.web.veterinarian.service.VeterinarianService;
...
public class VeterinarianController {
    ...
    {
        model.addAttribute("veterinarians", m_veterinarianService.findAll().veterinarians);
        //...
